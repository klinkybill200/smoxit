    ...
    <div className="relative mx-auto flex w-full max-w-[430px] items-stretch justify-between px-1 pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="flex w-20 shrink-0 items-start justify-center">
        <button
          ...
          className={cn(
            "animate-sos-breathe relative -mt-10 flex h-14 w-14 items-center justify-center rounded-full border-4 border-card bg-destructive text-destructive-foreground transition-bounce hover:scale-110 active:scale-95",
        ...
        <span className={cn(
          "pointer-events-none absolute bottom-[calc(env(safe-area-inset-bottom)+0.375rem)] left-1/2 -translate-x-1/2 text-[10px] font-black uppercase tracking-widest",
